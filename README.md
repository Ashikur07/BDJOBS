...
* **📂 Dynamic Job Posting:** A dedicated platform for recruiters to post and manage job listings efficiently.
* **🔍 Smart Filtering:** Advanced search and filtering options to help users find their specific job niche.
* **🔔 Job Alerts:** Personalized notifications and alerts based on user-defined job criteria.
* **📱 Ultra Responsive:** Pixel-perfect design that ensures cross-platform compatibility across mobile, tablet, and desktop.
* **🎬 Interactive UI:** Integrated with **Lottie Animations** and **Framer Motion** for an engaging user experience.

## 🛠️ Tech Stack
* **Frontend:** React.js + Vite
* **Styling:** Tailwind CSS (Modern & Adaptive)
